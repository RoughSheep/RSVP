...
switch s
    case 1
        filename{1}='C:\天大实习\RSVP\20181222lwt\Day1-5\Day2\';
    case 2
...
Indices = crossvalind('Kfold',numK*numBlc/numRound,numK*numBlc/numRound);  %%3*10=30 一共30个组 分成30个层 自己做自己的 一组一层 (一个靶一组 共30个靶)
